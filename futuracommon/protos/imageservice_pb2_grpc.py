...
if _version_not_supported:
    warnings.warn(
        ...
        + f' but the generated code in futuracommon/protos/imageservice_pb2_grpc.py depends on'
...
def add_ImageStreamServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('iamgestream.ImageStreamService', rpc_method_handlers)
