...
if _version_not_supported:
    warnings.warn(
        ...
        + f' but the generated code in futuracommon/protos/backend_change_pb2_grpc.py depends on'
...
class BackendServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.ChangeBackend = channel.unary_unary(
...
def add_BackendServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ChangeBackend': grpc.unary_unary_rpc_method_handler(
                    servicer.ChangeBackend,
